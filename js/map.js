...
//Target iPhone6 Plus
            ...
            var marker = createMarker(ctrACEE,"Andlinger Center for Energy and the Environment","<h4>Andlinger Center for Energy and the Environment</h4><p>The Andlinger Center for Energy and the Environment supports a vibrant and expanding program of research and teaching in the areas of sustainable energy-technology development, energy efficiency, and environmental protection and remediation. A chief goal of the center is to translate fundamental knowledge into practical solutions that enable sustainable energy production and the protection of the environment and global climate from energy-related anthropogenic change.</p><p><a target=\'_blank\' href=\'http://acee.princeton.edu/\'>acee.princeton.edu</a></p>")
